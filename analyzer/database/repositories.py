...
from models.analysis import AnalysisResult, AnalysisLog, NewsArticle
            ...
            with self.db_manager.get_connection() as conn:
                with conn.cursor() as cursor:
                    cursor.execute("""
                        ...
                        (article_id, stock_code, stock_name, reasoning)
                        VALUES (%s, %s, %s, %s)
            ...
            with self.db_manager.get_connection() as conn:
                with conn.cursor() as cursor:
                    cursor.execute("""
                        ...
                        (article_id, recommendation_id, stock_code, probability, reasoning, target_price, stop_loss)
            ...
            with self.db_manager.get_connection() as conn:
                with conn.cursor() as cursor:
                    cursor.execute("""
                        ...
                        (analysis_id, stock_code, stock_name, target_price, stop_loss, status)
                        VALUES (%s, %s, %s, %s, %s, 'pending')
                        RETURNING id
                    """, (analysis_id, stock_code, stock_name, target_price, stop_loss))
