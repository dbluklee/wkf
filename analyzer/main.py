...
def main():
    ...
    try:
        ...
        # 6. 리스너 시작
        logger.info("=" * 60)
        logger.info("Starting PostgreSQL LISTEN for new articles...")
        logger.info("Waiting for notifications on channel: 'new_article'")
        logger.info("=" * 60)

        listener = ArticleListener(db_manager, orchestrator.analyze_article)
